<template>
  <div>
    <div class="filed"></div>
     <a target="_blank" href="https://juejin.cn/post/7173498560380403719#heading-0">文章地址</a>
  </div>
</template>
...
.filed {
  ...
  --中圈: radial-gradient(
    ...
    center/20em 20em no-repeat;
  --大禁区: linear-gradient(to right, #43a63c calc(18em - 2px), transparent 0) 0
  ...
  --小禁区: linear-gradient(to right, #43a63c calc(6em - 2px), transparent 0) 0
      center/calc(100% - 6em + 2px) calc(20em - 4px) repeat-x,
    linear-gradient(to right, #fff 6em, transparent 0) 0 center/calc(100% - 6em)
      20em repeat-x;
  --球门: linear-gradient(to right, #43a63c calc(3em - 4px), transparent 0)
  ...
  --罚球点: radial-gradient(circle at 12em center, #fff 2px, transparent 0) 0
  ...
  --草坪: linear-gradient(90deg, transparent 50%, rgba(0, 0, 0, 0.5) 0% 100%)
    center/10% 100%;
